...
const Contacto = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm("service_xedip1o", "template_t0z9cfi", form.current, 'vvsATdb4z4kkoYGOa')
          .then((result) => {
...
Contáctenos
      ...
      <button type="submit" value="Send" > Enviar </button>
            ...
            <section className="contacto-right">
                ...
                <p className="resaltado">4342-6741 / 7363 / 7259 (Líneas rotativas)</p>
                </div>
                <div className="divider">
                ...
                <div className="divider">
                <p className="comun">Servicio de Urgencias- Emergencias – Atención Médica Domiciliaria:</p>
                <p className="resaltado">4959-9595
